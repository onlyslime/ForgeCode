...
def run_prompt_ui(session, *, mode: Callable[[], str]) -> None:
    ...
    slash_commands = ("/help", "/introduce", "/status", "/queue", "/steer", "/tools", "/model", "/plan", "/mode", "/connect", "/login", "/rules", "/files", "/skills", "/tree", "/diff", "/context", "/events", "/review", "/test", "/compact", "/undo", "/pause", "/resume", "/cancel", "/clear", "/quit", "/exit")
    argument_choices = {
