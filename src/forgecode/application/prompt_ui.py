...
def run_prompt_ui(session, *, mode: Callable[[], str]) -> None:
    ...
    slash_commands = ("/help", "/status", "/tools", "/model", "/plan", "/mode", "/connect", "/login", "/rules", "/files", "/skills", "/tree", "/diff", "/context", "/review", "/test", "/compact", "/undo", "/pause", "/resume", "/cancel", "/clear", "/quit", "/exit")
    argument_choices = {
