...
class MemoryStore:
    ...
    def __init__(self, guard: WorkspaceGuard):
        ...
        # Mutations are read-modify-write transactions.  Keep the read and
        # atomic replacement together so concurrent CLI/API callers in this
        # process cannot overwrite one another's entries.
