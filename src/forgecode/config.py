...
def parse_tool_policy_options(
    ...
    *,
    ...
    known_set = set(known)
    groups = {
        "read_only": {name for name in known if name in {"list_files", "read_file", "search", "workspace_summary", "repository_map", "find_files", "read_range", "list_symbols", "file_metadata", "find_definition", "find_references", "symbol_hover", "git_status", "git_diff", "git_log", "git_worktrees"}},
...
class EffectiveConfig:
    ...
    def validate(self) -> None:
        ...
        known_tools = {"list_files", "read_file", "search", "write_file", "apply_patch", "workspace_summary", "repository_map", "run_command", "find_definition", "find_references", "symbol_hover", "list_processes", "git_worktrees"}
