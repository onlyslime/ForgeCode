...
def test_command_classifier_handles_shell_and_git_variants():
    blocked = ["GIT  RESET   --HARD HEAD", "git clean -xfd", "git push origin main --force-with-lease", "git -C repo push origin +main", "git --git-dir=.git push origin +main", "shutdown /s", "sudo reboot"]
