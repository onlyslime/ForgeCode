...
def test_human_events_status_renders_bounded_tail():
    rendered = _human_result({"events_status": True, "filter": "error", "events": [{"sequence": 4, "kind": "tool_result", "outcome": "success", "elapsed_seconds": 1.25}, {"sequence": 5, "kind": "error", "outcome": "failed", "error_code": "provider_timeout", "elapsed_seconds": 2.0}]})
